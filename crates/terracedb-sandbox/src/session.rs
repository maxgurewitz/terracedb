...
use terracedb_git::{
    ...
    GitHostBridge, GitImportEntryKind, GitImportLayout, GitImportMode, GitImportRequest,
    GitImportSource, GitObjectFormat, GitOpenRequest,
...
use crate::{
    ...
    HoistReport, HoistRequest, HoistedSource, NodeDebugExecutionOptions, PackageInstallReport,
