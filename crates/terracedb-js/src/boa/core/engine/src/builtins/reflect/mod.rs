...
impl IntrinsicObject for Reflect {
    fn init(realm: &Realm) -> crate::JsResult<()> {
        ...
        BuiltInBuilder::with_intrinsic::<Self>(realm)
            ...
            .static_method_native(
                NativeFunction::from_suspend_fn_ptr(Self::construct),
                js_string!("construct"),
                2,
            )
...
impl Reflect {
    ...
    pub(crate) fn apply(
        ...
        Self::finish_interruptible_invoke(
            target.call_interruptible(this_arg, &args, context)?,
            context,
        )
    }
    ...
    pub(crate) fn construct(
        ...
        Self::finish_interruptible_construct(
            target.construct_interruptible(&args, Some(&new_target), context)?,
            context,
        )
    }
