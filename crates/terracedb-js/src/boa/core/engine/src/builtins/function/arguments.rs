use crate::{
    ...
    object::{
        ...
        internal_methods::{
            ...
            ordinary_get_interruptible, ordinary_set, ordinary_set_interruptible, ordinary_try_get,
...
impl UnmappedArguments {
    ...
    pub(crate) fn new(arguments_list: &[JsValue], context: &mut Context) -> JsResult<JsObject> {
...
impl JsData for MappedArguments {
    fn internal_methods(&self) -> &'static InternalObjectMethods {
        static METHODS: InternalObjectMethods = InternalObjectMethods {
            ...
            __try_get_interruptible__: arguments_exotic_try_get_interruptible,
            __get__: arguments_exotic_get,
            __get_interruptible__: arguments_exotic_get_interruptible,
            __set__: arguments_exotic_set,
            __set_interruptible__: arguments_exotic_set_interruptible,
...
pub(crate) fn arguments_exotic_try_get(
    ...
    match arguments_exotic_try_get_interruptible(obj, key, receiver, context)? {
...
pub(crate) fn arguments_exotic_try_get_interruptible(
    obj: &JsObject,
    key: &PropertyKey,
    receiver: JsValue,
    context: &mut InternalMethodPropertyContext<'_>,
            ...
            .get(index.get())
    {
        ...
        // b. Return Get(map, P).
        return Ok(ExecutionOutcome::Complete(Some(value)));
    }
...
pub(crate) fn arguments_exotic_get(
    ...
    match arguments_exotic_get_interruptible(obj, key, receiver, context)? {
        ExecutionOutcome::Complete(value) => Ok(value),
        ExecutionOutcome::Suspend(_) => Err(JsObject::suspended_internal_method_error(
            "property access",
        )),
...
pub(crate) fn arguments_exotic_get_interruptible(
    obj: &JsObject,
    key: &PropertyKey,
    receiver: JsValue,
    context: &mut InternalMethodPropertyContext<'_>,
...
pub(crate) fn arguments_exotic_set(
    ...
    match arguments_exotic_set_interruptible(obj, key, value, receiver, context)? {
        ExecutionOutcome::Complete(value) => Ok(value),
        ExecutionOutcome::Suspend(_) => Err(JsObject::suspended_internal_method_error(
            "property assignment",
        )),
...
pub(crate) fn arguments_exotic_set_interruptible(
    obj: &JsObject,
    key: PropertyKey,
    value: JsValue,
    receiver: JsValue,
