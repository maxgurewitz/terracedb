...
impl BuiltInConstructor for OrdinaryObject {
    ...
    fn constructor(
        ...
        if value.is_null_or_undefined() {
            Ok(JsObject::try_with_object_proto(context.intrinsics())?.into())
        } else {
...
impl OrdinaryObject {
    ...
    pub fn get_own_property_descriptors(
        ...
        let descriptors = JsObject::try_with_object_proto(context.intrinsics())?;
    ...
    pub(crate) fn from_property_descriptor(
        ...
        let obj = JsObject::try_with_object_proto(context.intrinsics())?;
