...
impl Default for IteratorPrototypes {
    fn default() -> Self {
        Self::try_default().expect(
            "iterator prototype allocation should not fail without an active allocation budget",
        )
    }
}

impl IteratorPrototypes {
    pub(crate) fn try_default() -> JsResult<Self> {
        Ok(Self {
            iterator: JsObject::try_with_null_proto()?,
            async_iterator: JsObject::try_with_null_proto()?,
            async_from_sync_iterator: JsObject::try_with_null_proto()?,
            array: JsObject::try_with_null_proto()?,
            set: JsObject::try_with_null_proto()?,
            string: JsObject::try_with_null_proto()?,
            regexp_string: JsObject::try_with_null_proto()?,
            map: JsObject::try_with_null_proto()?,
            #[cfg(feature = "intl")]
            segment: JsObject::try_with_null_proto()?,
            iterator_helper: JsObject::try_with_null_proto()?,
            wrap_for_valid_iterator: JsObject::try_with_null_proto()?,
        })
    }
...
impl IteratorRecord {
    ...
    pub(crate) fn if_abrupt_close_iterator(
        ...
        match completion {
            ...
            CompletionRecord::Suspend => CoroutineState::Break(Err(
                crate::error::PanicError::new(
                    "iterator helper received suspended completion unexpectedly",
                )
                .into(),
            )),
        }
