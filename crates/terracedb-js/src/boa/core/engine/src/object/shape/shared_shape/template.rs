...
impl ObjectTemplate {
    ...
    pub(crate) fn create<T: NativeObject>(
        ...
        self.try_create(data, storage)
    }

    pub(crate) fn try_create<T: NativeObject>(
        &self,
        data: T,
        storage: Vec<JsValue>,
    ) -> JsResult<JsObject> {
        ...
        JsObject::try_from_object_and_vtable(object, internal_methods)
    }
    ...
    pub(crate) fn create_with_indexed_properties<T: NativeObject>(
        ...
        self.try_create_with_indexed_properties(data, storage, indexed_properties)
    }

    pub(crate) fn try_create_with_indexed_properties<T: NativeObject>(
        &self,
        data: T,
        storage: Vec<JsValue>,
        indexed_properties: IndexedProperties,
