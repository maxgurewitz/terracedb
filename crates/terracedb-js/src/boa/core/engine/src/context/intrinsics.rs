...
impl Intrinsics {
    ...
    pub(crate) fn uninit(root_shape: &RootShape) -> Option<Self> {
        Self::try_uninit(root_shape).ok()
    }

    /// Creates a new set of uninitialized intrinsics.
    pub(crate) fn try_uninit(root_shape: &RootShape) -> JsResult<Self> {
        let constructors = StandardConstructors::try_default()?;
        let templates = ObjectTemplates::new(root_shape, &constructors);

        Ok(Self {
            constructors,
            objects: IntrinsicObjects::try_uninit()?,
            templates,
        })
    }
...
impl Default for StandardConstructor {
    fn default() -> Self {
        Self::try_default().expect(
            "standard constructor allocation should not fail without an active allocation budget",
        )
    }
}

impl StandardConstructor {
    fn try_default() -> JsResult<Self> {
        Ok(Self {
            constructor: JsFunction::try_empty_intrinsic_function(true)?,
            prototype: JsObject::try_with_null_proto()?,
        })
    }
    ...
    fn try_with_prototype(prototype: JsObject) -> JsResult<Self> {
        Ok(Self {
            constructor: JsFunction::try_empty_intrinsic_function(true)?,
            prototype,
        })
...
impl Default for StandardConstructors {
    fn default() -> Self {
        Self::try_default().expect(
            "standard constructors allocation should not fail without an active allocation budget",
        )
    }
}
...
impl StandardConstructors {
    fn try_default() -> JsResult<Self> {
        Ok(Self {
            object: StandardConstructor::try_with_prototype(JsObject::try_from_object_and_vtable(
            ...
            function: StandardConstructor {
                constructor: JsFunction::try_empty_intrinsic_function(true)?,
                prototype: JsFunction::try_empty_intrinsic_function(false)?.into(),
            },
            async_function: StandardConstructor::default(),
            generator_function: StandardConstructor::default(),
            array: StandardConstructor::try_with_prototype(JsObject::try_from_proto_and_data(
                None, Array,
            )?)?,
            bigint: StandardConstructor::default(),
            number: StandardConstructor::try_with_prototype(JsObject::try_from_proto_and_data(
                None, 0.0,
            )?)?,
            boolean: StandardConstructor::try_with_prototype(JsObject::try_from_proto_and_data(
                None, false,
            )?)?,
            string: StandardConstructor::try_with_prototype(JsObject::try_from_proto_and_data(
                None,
                js_string!(),
            )?)?,
...
impl IntrinsicObjects {
    ...
    pub(crate) fn try_uninit() -> JsResult<Self> {
        Ok(Self {
            reflect: JsObject::try_with_null_proto()?,
            math: JsObject::try_with_null_proto()?,
            json: JsObject::try_with_null_proto()?,
            throw_type_error: JsFunction::try_empty_intrinsic_function(false)?,
            array_prototype_values: JsFunction::try_empty_intrinsic_function(false)?,
            array_prototype_to_string: JsFunction::try_empty_intrinsic_function(false)?,
            iterator_prototypes: IteratorPrototypes::try_default()?,
            generator: JsObject::try_with_null_proto()?,
            async_generator: JsObject::try_with_null_proto()?,
            atomics: JsObject::try_with_null_proto()?,
            eval: JsFunction::try_empty_intrinsic_function(false)?,
            uri_functions: UriFunctions::try_default()?,
            is_finite: JsFunction::try_empty_intrinsic_function(false)?,
            is_nan: JsFunction::try_empty_intrinsic_function(false)?,
            parse_float: JsFunction::try_empty_intrinsic_function(false)?,
            parse_int: JsFunction::try_empty_intrinsic_function(false)?,
            #[cfg(feature = "annex-b")]
            escape: JsFunction::try_empty_intrinsic_function(false)?,
            #[cfg(feature = "annex-b")]
            unescape: JsFunction::try_empty_intrinsic_function(false)?,
            #[cfg(feature = "intl")]
            intl: JsObject::try_new_unique(None, Intl::new()?)?,
            #[cfg(feature = "intl")]
            segments_prototype: JsObject::try_with_null_proto()?,
            #[cfg(feature = "temporal")]
            temporal: JsObject::try_with_null_proto()?,
            #[cfg(feature = "temporal")]
            now: JsObject::try_with_null_proto()?,
        })
    }
