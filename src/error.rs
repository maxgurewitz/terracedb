...
pub enum Error {
    ...
    JsInvalidOperand,
    JsModuleExportAmbiguous { export: String },
    JsModuleExportNotFound { specifier: String, export: String },
    JsModuleNotDefined { specifier: String },
    JsNotCallable,
    ...
    JsUninitializedBinding { name: String },
    MissingConsole,
